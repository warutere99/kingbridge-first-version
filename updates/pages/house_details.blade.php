   ...
   <div class="row">
        <div class="col-lg-8 bg-light">
          ...
          <ul class="thumbs mt-3">
              @if(isset($img[1]))
          <li onclick="thumbChange(0)"><img class="thumb-img" src=" {{ $img[1]}}"></li>
              @endif
              @if(isset($img[2]))
          <li onclick="thumbChange(1)"><img class="thumb-img" src=" {{ $img[2]}}"></li>
              @endif
              @if(isset($img[3]))
          <li onclick="thumbChange(2)"><img class="thumb-img" src=" {{ $img[3]}}"></li>
              @endif
        ...
        <div class="col-lg-4">
          ...
          <div class="mb-4 p-4 text-center bg-light">
              <p> <h4 class="mb-0"> KSh {{$house_ad->price}} Million </h4> <small>NEGOTIABLE</small> <span> REF-ID:{{$house_ad->id}}</span> </p>
          </div>
<div class="mb-4 p-4 text-center bg-light">
              <p>
