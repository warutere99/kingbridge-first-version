              ...
              <div class="card car-wrap rounded ftco-animate">
                ...
                <div class="text">
                  ...
                  <div class="d-flex mb-3">
                    ...
                    <p class="price ml-auto">Ksh {{$appartment->price}}</p>
                  </div>
                  <p class="d-flex mb-0 d-block"><a href="{{ route('apartment_details',$appartment->id)}}" class="btn btn-primary py-2 mr-1">Buy now</a> <a href="col-lg-6 col-md-6" class="btn btn-secondary py-2 ml-1">Details</a></p>
                </div>
                    </div>
              </div>
              @endforeach
