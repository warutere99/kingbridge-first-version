...
<section class="ftco-section ftco-car-details">
     ...
     <div class="row">
          <div class="col-lg-8 bg-light">
            <p><h3> {{$car->title}} </h3></p>
            <p><h6> Dealer car-used</p>
            <p><h7>Added 2 days ago</h7></p>
            <script>
            	function thumbChange(num) {
            		var thumb ='images/vw' +num +'.jpeg';
          ...
          <div class="col-lg-4">
            ...
            <div class="mb-4 p-4 text-center bg-light">
            	<p> <h4 class="mb-0"> KSh {{$car->price}} </h4> <small>NEGOTIABLE</small> <span> REF-ID:{{$car->id}}</span> </p>
            </div>
<div class="mb-4 p-4 text-center bg-light">
				<p>
