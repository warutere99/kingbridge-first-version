...
<div class="collapse navbar-collapse" id="ftco-nav">
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item"><a href="{{route('house')}}" class="nav-link"> Houses</a></li>
...
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/aboutus.jpg');" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/house1.jpg);">
					</div>
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <p>Kingship has been brought up by three traits which are Love,Trust and Loyalty the foundation of Kingship was made upon those three values hence the strong reputation that the company obtains among its clients.
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading"> Kingship leadership</span>
