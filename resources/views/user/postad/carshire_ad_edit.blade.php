  ...
  <div class="overlay"> <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
        ...
        <h1 class="mb-3 bread">Cars Hire Ad</h1>
      </div>
    </div>
  </div></div>
...
<section class="ftco-section bg-light">
 ...
 <a href="{{ route('user.user_cart')}}" class="btn btn-primary w-25">Back</a>
 	<div class="card"> 
     <div class="card-body"> 
 	<form method="post" action="{{ route('postad.update_car_ad', $carshire_ad->id) }}">
    @method('PUT')
    ...
    <div class="form-group" >
      ...
      <select name="category_id" class="form-control  @error('category_id') is-invalid  @enderror">
        <option value="">Choose a Category</option>
                ...
                <option value="{{ $c->id }}" 
                  @if($c->id == $carshire_ad->category_id)
                    selected
                    @endif
      ...
      <select name="subcategory_id" class="form-control  @error('subcategory_id') is-invalid  @enderror">
        <option value="">Choose a Subcategory</option>
            @foreach($subcategories as $c)
                <option value="{{ $c->id }}" 
                  @if($c->id == $carshire_ad->subcategory_id)
                    selected
                    @endif
    ...
    <div class="form-group" >
      ...
      <input type="text" name="title" value="{{ $carshire_ad->title }}" class="form-control  @error('title') is-invalid  @enderror">
        @error('title')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
    ...
    <label class="label-control">Choose Ad Post Type</label>
      <select name="ads_type" class="form-control  @error('ads_type') is-invalid  @enderror">
         <option> {{ $carshire_ad->ads_type }} </option>
         <option>Sale</option>
         <option>Rent</option> 
      </select> 
        @error('ads_type')
    ...
    <div class="form-group">
      <label class="label-control">Make</label>
        <select name="make" class="form-control  @error('make') is-invalid  @enderror">
                <option >{{ $carshire_ad->make }}</option>
                <option>Mazda</option>
                <option>Benz</option>
      ...
      <div class="form-group">
        <label class="label-control">Model</label>
          <select name="model" class="form-control  @error('model') is-invalid  @enderror">
              <option>{{ $carshire_ad->model }}</option>
      ...
      <div class="form-group" >
        ...
        <input type="date" value="{{ $carshire_ad->year_of_build }}" name="year_of_build" class="form-control  @error('year_of_build') is-invalid  @enderror">
          @error('year_of_build')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
    ...
    <div class="form-group">
      <label class="label-control">Choose Ad Transmission</label>
        <select name="transmission" class="form-control  @error('transmission') is-invalid  @enderror">
           <option> {{ $carshire_ad->transmission }} </option>
           <option>Auto</option>
      ...
      <div class="form-group">
        <label class="label-control">Choose Ad Fuel Type</label>
          <select name="fuel_type" class="form-control  @error('fuel_type') is-invalid  @enderror">
             <option> {{ $carshire_ad->fuel_type }} </option>
      ...
      <div class="form-group" >
        ...
        <input type="text" name="condition" value="{{ $carshire_ad->condition }}"  class="form-control  @error('condition') is-invalid  @enderror">
          @error('condition')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <input type="number" name="price" value="{{ $carshire_ad->price }}" class="form-control  @error('price') is-invalid  @enderror">
          @error('price')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <input type="number" name="mileage" value="{{ $carshire_ad->mileage }}" class="form-control  @error('mileage') is-invalid  @enderror">
          @error('mileage')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <textarea  name="description" class="form-control  @error('description') is-invalid  @enderror">{{$carshire_ad->description }}</textarea>
          @error('description')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group" >
        ...
        <input type="file" name="photos" value="{{$carshire_ad->photos }}" multiple="true" class="form-control  @error('photos') is-invalid  @enderror">
          @error('photos')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="form-group">
        <label class="label-control">Packages</label>
          <select name="package_id" class="form-control  @error('package_id') is-invalid  @enderror">
            <option value="{{$carshire_ad->package_id }}">{{$carshire_ad->Package->package_name }}{{$carshire_ad->Package->package_amount }}</option>
