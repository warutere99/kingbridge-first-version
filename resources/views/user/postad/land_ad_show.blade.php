  ...
  <div class="col-lg-10">
   ...
   <div class="table-responsive"> 
 	<table class="table table-bordered table-striped table-hover datatable student-datatable">
 		...
 		<tr>
 		<tr> <td>ID: {{ $land_ad->id }} </td> </tr>
        <tr> <td>Category: {{ $land_ad->Category->category_name }}</td> </tr>
        <tr><td>Subcategory: {{ $land_ad->subcategory->subcategory_name }}</td></tr>
        <tr> <td>County: {{ $land_ad->county->county_name }}</td></tr>
        <tr><td>City: {{ $land_ad->city->city }}</td></tr>
        <tr> <td>User: {{ $land_ad->User->firstname }} {{ $land_ad->User->secondname }}</td></tr>
        <tr><td>Title: {{ $land_ad->title }}</td></tr>
    <tr><td>Ads_type: {{ $land_ad->ads_type }}</td></tr>
     <tr> <td>Price: {{ $land_ad->price }}</td></tr>
        <tr> <td>Square Meters: {{ $land_ad->square_meters }}</td></tr>
       <tr> <td>Amenities: {{ $land_ad->amenities }}</td></tr>
        <tr> <td>Description: {{ $land_ad->description }}</td></tr>
        <tr><td>Package: {{ $land_ad->Package->package_name }} {{ $land_ad->Package->package_amount }}</td></tr>
        <tr><td> <img src="{{ strtok($land_ad->photos, ',') }}" width="100">
        </td></tr>
