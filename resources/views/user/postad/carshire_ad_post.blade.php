 ...
 <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
        ...
        <h1 class="mb-3 bread">Cars Hire Hire Ad</h1>
      </div>
    </div>
  </div>
 ...
 <div class="container">
  ...
  <div class="card" style="border-radius: 3.25rem;">
    <div class="card-header ">
      <h2 class="text-center"> Car Hire Ad Post </h2>  
    </div>
    <div class="card-body">
    <form method="post" action="{{ route('postad.store_carshire_ad_post')}}" enctype="multipart/form-data">
