 ...
 <div class="container">
  ...
  <div class="card" style="border-radius: 3.25rem;">
    <div class="card-header ">
      <h2 class="text-center"> House Ad Post </h2>  
    </div>
    <div class="card-body">
    <form method="post" action="{{ route('postad.store_house_ad_post')}}" enctype="multipart/form-data">
    ...
    <div class="form-group row p-3" >
      ...
      <div class="form-group row p-3" >
        ...
        <div class="input-group mb-3 col-md-4">
          ...
          <select name="bathroom" class="form-control  @error('bathroom') is-invalid  @enderror">
