        ...
        <div class="col-lg-2 col-md-5 col-sm-5">
          ...
          <div class="col-lg-10">
            <div class="row">
              ...
              <h5><a href="{{ route('apartment_details',$appartment->id)}}">{{$appartment->title}}</a></h5>
              <p><i class="fa fa-map-marker" aria-hidden="true"></i> {{$appartment->city->city}}</p>
              </div>
              </div>
              
              <div class="property-info-area d-flex flex-wrap">
              <p>Acres<span>1/2</span></p>
              <p>Bedrooms<span>{{$appartment->bedroom}}</span></p>
              <p>Bathrooms <span>{{$appartment->bathroom}}</span></p>
              <p>Parking <span>{{$appartment->parking}}</span></p>
              ...
              <p class="price">Ksh{{ $appartment->price}}</p></a>
              </div>
              </div>
              </div>
              </div>
