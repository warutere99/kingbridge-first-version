...
<section class="hero-wrap hero-wrap-3 js-smallheight" style="background-image: url('images/apartment_out3.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay">
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Apartment <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">land listing</h1>
          </div>
        </div>
      </div></div>
    ...
    <h5><a href="{{ route('land_details',$land->id)}}">{{$land->title}}</a></h5>
    <p><i class="fa fa-map-marker" aria-hidden="true"></i> {{$land->city->city}}</p>
    </div>
    </div>
    
    <div class="property-info-area d-flex flex-wrap">
    <p>Acres<span>1/2</span></p>
    <p>Bedrooms<span>{{$land->bedroom}}</span></p>
    <p>Bathrooms <span>{{$land->bathroom}}</span></p>
    <p>Parking <span>{{$land->parking}}</span></p>
    ...
    <p class="price">Ksh{{ $land->price}}</p></a>
    </div>
    </div>
    </div>
    </div>
