...
<head>
  ...
  <title>Kingship Admin Dashboard</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('admin/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Kingship Admin</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.counties.index')}}" class="nav-link
             @if($segment=='counties')
             active
             @endif
             ">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.carmake.index')}}" class="nav-link
             @if($segment=='carmake')
             active
             @endif
             ">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.carmodel.index')}}" class="nav-link
             @if($segment=='carmodel')
             active
             @endif
             ">
